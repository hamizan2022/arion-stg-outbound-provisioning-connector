...
public class ArionProvisioningConnectorConfig implements Serializable {

    private static final long serialVersionUID = -4476579393653814433L;

    private static final Log log = LogFactory.getLog(ArionProvisioningConnectorConfig.class);
    private Properties configs;

    /**
     * @param configs
     */
    public ArionProvisioningConnectorConfig(Properties configs) {
    ...
    public List<String> getRequiredAttributeNames() {
        ...
        String requiredAttributes = this.configs
                .getProperty(ArionConnectorConstants.PropertyConfig.REQUIRED_FIELDS);
    ...
    public String getUserIdClaim() throws IdentityProvisioningException {
        String userIDClaim = this.configs
                .getProperty(ArionConnectorConstants.PropertyConfig.USER_ID_CLAIM);
